...
(function () {
  ...
  function mount() {
    ...
    style.textContent = '#dc4-version{position:fixed;top:calc(env(safe-area-inset-top,0px) + 6px);right:8px;z-index:10000;padding:3px 8px;border:1px solid #cbd5e1;border-radius:12px;background:#fff;color:#334155;font:600 11px/1.4 system-ui,sans-serif;cursor:pointer;box-shadow:0 1px 4px #0001}#dc4-version:focus-visible{outline:2px solid #2563eb;outline-offset:2px}body{padding-top:28px!important}@media print{#dc4-version{display:none}body{padding-top:0!important}}';
